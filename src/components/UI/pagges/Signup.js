    ...
    return (
            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        ...
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">learn with me</div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2 class="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">Create Acount</h2>
                    <div class="mt-12">
                        <form>
                            <div>
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Arleady have an acount? <a class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign In</a>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="REMOVE-THIS-ELEMENT-IF-YOU-ARE-USING-THIS-PAGE hidden treact-popup fixed inset-0 flex items-center justify-center">
        <div class="max-w-lg p-8 sm:pb-4 bg-white rounded shadow-lg text-center sm:text-left">
          ...
          <p>dszxfcgvhbjnkml,.<span class="font-bold">zxvbee</span>szdzxfcfgv hbjkm,..</p>
